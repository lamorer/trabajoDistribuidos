...
public class Pruebas {
    public static void main(String[] args) {
        ...
        System.out.println("============================================");
        ManoPoker m1 = evaluarMano(j1, mesa.getCartasEnMesa());
        ManoPoker m2 = evaluarMano(j2, mesa.getCartasEnMesa());
        ManoPoker m3 = evaluarMano(j3, mesa.getCartasEnMesa());
